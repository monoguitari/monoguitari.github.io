export const opportunities = [
  ...
  },
  {
    ...
    technology: ["Docker", "NVIDIA Parabricks", "GPU Clusters"],
    description:
  ...
  },
  {
    ...
    company: "Embrace Medical",
    technology: ["React", "Machine Learning frameworks", "Python"],
    description:
  ...
  {
    dates: "March 2024 - Present",
    title: "Science Communicator and Web Designer/Developer",
    company: "Serre Lab",
    technology: ["React", "Figma", "Neuro AI tools"],
    description:
  ...
  },
  {
    ...
    title: "Researcher",
    company: "OppNet Summer Science Research Program",
    technology: [],
    description:
